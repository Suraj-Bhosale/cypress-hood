...
import regressionManufacturingSteps from '../../../utils/Regression_steps/CCLP_IS_RegressionPath/manufacturing_steps'
import regressionSatelliteSteps from '../../../utils/Regression_steps/CCLP_IS_RegressionPath/satelite_lab_steps'
...
context('CCLP IS Therapy Satellite Regression Path', () => {
    beforeEach(() => {
      cy.clearCookies();
