...
import order_steps from '../../../utils/Regression_steps/CCLP_EU_RegressionPath/ordering_steps'
import therapies from '../../../fixtures/therapy.json'

context('CCLP EU Therapy Collection Regression Path', () => {
    beforeEach(() => {
      cy.clearCookies();
    ...
    it('Cryopreservation Shipping Summary ', () => {
      regressionCommonHappyPath.commonOrderingHappyPath(scope, therapy)
      regressionCollectionSteps.cryopreservationShippingSummary.previousHappyPathSteps(scope,therapy)
