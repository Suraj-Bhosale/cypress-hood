...
import collection_steps from '../../../utils/HappyPath_steps/CCCP_IS_HappyPath/collection_steps'
...
context('CCCP IS Therapy Manufacturing Regression Path', () => {
    const scope = {};
    ...
    it('Verify Shipper ', () => {
        ...
        regressionCommonHappyPath.commonCollectionHappyPath(scope, therapy);
         regressionCommonHappyPath.commonSatelliteHappyPath(scope);
        regressionManufacturingSteps.verifyShipper.previousHappyPathSteps();
   
        //	[NEG] Verify COI field with invalid values. 
        regressionManufacturingSteps.verifyShipper.invalidCoi();
    ...
    it('Transfer Product to Intermediary Part1', () => {
        ...
        regressionCommonHappyPath.commonCollectionHappyPath(scope, therapy);
        regressionCommonHappyPath.commonSatelliteHappyPath(scope, therapy)
        regressionManufacturingSteps.transferProductToStorage1.previousHappyPathSteps(scope)

        //[NEG] Verify the 'Scan the COI on the LN2 shipper' with invalid data.
        regressionManufacturingSteps.transferProductToStorage1.negLn2Shipper()

        //[NEG] Verify "Scan the COI on the cassette label" Confirm button when no/invalid data is filled
        regressionManufacturingSteps.transferProductToStorage1.negCassetteLabel()

        //[NEG] Verify "Scan the COI on the bag" Confirm button when no/invalid data is filled
        regressionManufacturingSteps.transferProductToStorage1.negBag()
        ...
        regressionManufacturingSteps.transferProductToStorage1.saveAndClosePos()
    });
    ...
    it('Confirmation Of Label ApplicationPart1', () => {
        ...
        // [NEG]Verify with invalid data and if the 'next' button is disabled incase of Scan or enter the COI with bag identifier on Hebrew cassette 1 label..' field kept empty 
        regressionManufacturingSteps.confirmationOfLabelApplicationPart2.hebrewCassetteNeg();
