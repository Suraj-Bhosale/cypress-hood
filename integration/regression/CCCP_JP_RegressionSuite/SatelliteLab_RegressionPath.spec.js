...
import regressionManufacturingSteps from '../../../utils/Regression_steps/CCCP_JP_RegressionPath/manufacturing_steps'
import regressionSatelliteSteps from '../../../utils/Regression_steps/CCCP_JP_RegressionPath/satelite_lab_steps'
...
context('CCCP JP Therapy Satellite Regression Path', () => {
    beforeEach(() => {
      cy.clearCookies();
