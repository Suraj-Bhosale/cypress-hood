...
context('CCCP US Therapy Ordering Regression Path', () => {
  beforeEach(() => {
    cy.clearCookies();
  ...
  it('Patient Information ', () => {
   ...
   //	[NEG] Verify Next button is disabled when No treatment ordering site is selected from the dropdown
   regressionOrderingSteps.patientInformation.negNoTreatmentSelected(scope.patientInformation, therapy)
  ...
  it('Scheduling', () => {
    ...
    // [POS] Verify that user should be able to select a different site.
    regressionOrderingSteps.scheduleCollection.selectDifferentSites();
