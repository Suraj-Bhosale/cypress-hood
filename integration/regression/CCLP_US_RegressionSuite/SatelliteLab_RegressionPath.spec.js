...
import regressionSatelliteSteps from '../../../utils/Regression_steps/CCLP_US_RegressionPath/satelite_lab_steps'
...
import order_steps from '../../../utils/Regression_steps/CCLP_US_RegressionPath/ordering_steps'
import therapies from '../../../fixtures/therapy.json'
import input from '../../../fixtures/inputs.json'

context('CCLP US Therapy Satellite Regression Path', () => {
    beforeEach(() => {
      cy.clearCookies();
    ...
    it('Check Statuses Of Satellite Module', () => {
      ...
      //CCLP-US- SatelliteLab:Check the status of each step for SatelliteLab module
