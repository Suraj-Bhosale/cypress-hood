...
import col_steps from '../../utils/HappyPath_steps/CCLP_IS_HappyPath/collection_steps';
import sat_steps from '../../utils/HappyPath_steps/CCLP_IS_HappyPath/satelite_lab_steps';
import m_steps from '../../utils/HappyPath_steps/CCLP_IS_HappyPath/manufacturing_steps.js';
import inf_steps from '../../utils/HappyPath_steps/CCLP_IS_HappyPath/infusion_steps';
...
context('CCLP IS Therapy Happy Path', () => {
  beforeEach(() => {
    cy.server();
  ...
  it('Collection flow', () => {
    ...
    col_steps.collectionTransferProductToShipper(scope.coi, "ln-2-shipper-ship-bags-from-apheresis-site-to-satellite-lab-cclp-is");
  ...
  it('Satellite Lab flow', () => {
    ...
    sat_steps.satLabVerifyShipment('satellite-lab', '-cclp-is', scope.coi);
  ...
  it('Manufacturing flow', () => {
    ...
    m_steps.manufacturingVerifyShipper(scope.coi, 'satellite-lab', '-cclp-is');
  ...
  it('Infusion flow', () => {
    ...
    cy.get(".patient-id")
      .contains(scope.patientInformation.subjectNumber)
      .click();
    inf_steps.infusionReceiveShipment('manufacturing-site', '-cclp-is', scope.coi);
