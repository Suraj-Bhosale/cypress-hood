import order_steps from '../../utils/HappyPath_steps/EMEA_LCLP_DC_QR_HappyPath/ordering_steps_cilta';
import col_steps from '../../utils/HappyPath_steps/EMEA_LCLP_DC_QR_HappyPath/collection_steps_cilta';
import wdc_steps from '../../utils/HappyPath_steps/EMEA_LCLP_DC_QR_HappyPath/wdc_steps_cilta'
import m_steps from '../../utils/HappyPath_steps/EMEA_LCLP_DC_QR_HappyPath/manufacturing_steps_cilta.js';
import inf_steps from '../../utils/HappyPath_steps/EMEA_LCLP_DC_QR_HappyPath/infusion_steps_cilta';
...
context('EMEA LCDC QR Therapy Happy Path', () => {
  // beforeEach(() => {
  //   cy.server();
  ...
  // const scope = {};
  // const region = 'US';
  // const therapy = therapies.emea_lcdc_qr;
  ...
  let mutationQuery = 'createApprovedOrderTransaction';
    ...
    makeGraphqlCypressRequest(
      orderMutationRequest(mutationQuery, mutationResponse, 'cilta-cel-jnj-emea-lclp-dc-qr'),
      orderVariables,
  ...
  it('Collection flow', () => {
    ...
    col_steps.collectionBagIdentificationEmeaLc();
    ...
    col_steps.collectionShippingSummaryEmeaLc(scope);
  });
  ...
  it('Manufacturing flow', () => {
    ...
    cy.get('.wdc-row_coi')
      .contains('div', scope.coi)
      .click();
    wdc_steps.wdcVerifyShipper('-emea-lcdc-qr', scope.coi);
    ...
    wdc_steps.wdcTransferProductToShipperEmeaCcdc(scope.coi, therapy);
