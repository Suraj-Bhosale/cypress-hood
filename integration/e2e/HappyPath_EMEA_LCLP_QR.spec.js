import order_steps from '../../utils/HappyPath_steps/EMEA_LCLP_QR_HappyPath/ordering_steps_cilta';
import col_steps from '../../utils/HappyPath_steps/EMEA_LCLP_QR_HappyPath/collection_steps_cilta';
import m_steps from '../../utils/HappyPath_steps/EMEA_LCLP_QR_HappyPath/manufacturing_steps_cilta.js';
import inf_steps from '../../utils/HappyPath_steps/EMEA_LCLP_QR_HappyPath/infusion_steps_cilta';
...
context('EMEA LC Therapy Happy Path', () => {
  ...
  const scope = {};
  const region = 'US';
  const therapy = therapies.emea_lc_qr;
  ...
  it('Creates and Approves an order through api', () => {
    ...
    makeGraphqlCypressRequest(
      orderMutationRequest(mutationQuery, mutationResponse, 'cilta-cel-jnj-emea-lclp-qr'),
      orderVariables,
