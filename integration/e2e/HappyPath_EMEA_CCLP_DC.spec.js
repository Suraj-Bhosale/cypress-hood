...
import order_steps from '../../utils/HappyPath_steps/EMEA_CCLP_DC_HappyPath/ordering_steps_cilta';
import wdc_steps from '../../utils/HappyPath_steps/EMEA_CCLP_DC_HappyPath/wdc_steps_cilta'
import col_steps from '../../utils/HappyPath_steps/EMEA_CCLP_DC_HappyPath/collection_steps_cilta';
import m_steps from '../../utils/HappyPath_steps/EMEA_CCLP_DC_HappyPath/manufacturing_steps_cilta.js';
import inf_steps from '../../utils/HappyPath_steps/EMEA_CCLP_DC_HappyPath/infusion_steps_cilta';
import sat_steps from '../../utils/HappyPath_steps/EMEA_CCLP_DC_HappyPath/satelite_lab_steps_cilta'
...
context('EMEA CCDC Therapy Happy Path', () => {
  ...
  it('Creates and Approves an order through api', () => {
    ...
    .then(response => {
      ...
      scope.patientInformation = {
        ...
        monthOfBirth: patientData.customFields.monthOfBirth.charAt(0).toUpperCase() + patientData.customFields.monthOfBirth.slice(1),
        yearOfBirth: patientData.customFields.yearOfBirth,
  ...
  it('Satellite Lab flow', () => {
    ...
    sat_steps.satLabCryopreservationLabelscclp(scope.coi, 'EMEA Cilta-Cel CCDC');
    ...
    sat_steps.satLabPrintShipperLabels(therapy, 'EMEA Cilta-Cel CCDC');
  ...
  it('Manufacturing flow', () => {
    ...
    m_steps.manufacturingProductReceiptEmea(scope.patientInformation.patientId, therapy);
  ...
  it('WDC flow', () => {
    ...
    wdc_steps.wdcProductRecieptSummary(therapy);
