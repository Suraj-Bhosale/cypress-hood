...
import m_steps from '../../utils/HappyPath_steps/LCLP_US_HappyPath/manufacturing_steps.js';
...
context('LCLP US Therapy Happy Path', () => {
  beforeEach(() => {
    cy.server();
  ...
  it('Manufacturing flow', () => {
    ...
    m_steps.manufacturingVerifyShipper(scope.coi, 'apheresis-site', '');
  ...
  it('Infusion flow', () => {
    ...
    cy.get('.patient-id')
      .contains(scope.patientInformation.subjectNumber)
      .click();
    inf_steps.infusionReceiveShipment('manufacturing-site', '', scope.coi);
