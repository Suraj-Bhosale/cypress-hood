...
context('CMCP US Therapy Happy Path', () => {
  beforeEach(() => {
    cy.server();
  ...
  it('Satellite Lab flow', () => {
    ...
    sat_steps.satLabVerifyShipment('manufacturing-site', '-cmcp-us', scope.coi);
  ...
  it('Infusion flow', () => {
    ...
    cy.get(".patient-id")
      .contains(scope.patientInformation.subjectNumber)
      .click();
    inf_steps.infusionReceiveShipment('manufacturing-site', '-cmcp-us', scope.coi);
