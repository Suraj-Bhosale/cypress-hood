...
context('CCLP JP Therapy Happy Path', () => {
  beforeEach(() => {
    cy.server();
  ...
  it('Collection flow', () => {
    ...
    col_steps.collectionTransferProductToShipper(scope.coi, "ln-2-shipper-ship-bags-from-apheresis-site-to-satellite-lab-cclp-jp");
