import order_steps from '../../utils/HappyPath_steps/LCLP_CILTA_US_HappyPath/ordering_steps_cilta';
import col_steps from '../../utils/HappyPath_steps/LCLP_CILTA_US_HappyPath/collection_steps_cilta';
import m_steps from '../../utils/HappyPath_steps/LCLP_CILTA_US_HappyPath/manufacturing_steps_cilta.js';
import inf_steps from '../../utils/HappyPath_steps/LCLP_CILTA_US_HappyPath/infusion_steps_cilta';
...
beforeEach(() => {
  ...
  it('Creates and Approves an order through api', () => {
    ...
    makeGraphqlCypressRequest(
      orderMutationRequest(mutationQuery, mutationResponse, 'cilta-cel-jnj-us-lclp'),
      orderVariables,
