import order_steps from '../../utils/HappyPath_steps/EMEA_CCLP_QR_HappyPath/ordering_steps_cilta';
import col_steps from '../../utils/HappyPath_steps/EMEA_CCLP_QR_HappyPath/collection_steps_cilta';
import m_steps from '../../utils/HappyPath_steps/EMEA_CCLP_QR_HappyPath/manufacturing_steps_cilta.js';
import inf_steps from '../../utils/HappyPath_steps/EMEA_CCLP_QR_HappyPath/infusion_steps_cilta';
import sat_steps from '../../utils/HappyPath_steps/EMEA_CCLP_QR_HappyPath/satelite_lab_steps_cilta'
...
context('EMEA CC QR Therapy Happy Path', () => {
...
beforeEach(() => {
  ...
  const scope = {};
  const region = 'EU';
  const therapy = therapies.emea_cc_qr;
  ...
  it('Creates and Approves an order through api', () => {
    ...
    makeGraphqlCypressRequest(
      orderMutationRequest(mutationQuery, mutationResponse, 'cilta-cel-jnj-emea-cclp-qr'),
      orderVariables,
  ...
  it('Satellite Lab flow', () => {
    ...
    sat_steps.satLabCryopreservationLabelscclp(scope.coi, 'EMEA Cilta-Cel CC QR');
    ...
    sat_steps.satLabPrintShipperLabels(therapy, 'EMEA Cilta-Cel CC QR');
