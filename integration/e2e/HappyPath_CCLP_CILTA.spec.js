...
context('CCLP CILTA Therapy Happy Path', () => {
  ...
  it('Creates and Approves an order through api', () => {
    ...
    makeGraphqlCypressRequest(
      orderMutationRequest(mutationQuery, mutationResponse, 'cilta-cel-jnj-us-cclp'),
      orderVariables,
  ...
  it('Collection flow', () => {
    ...
    col_steps.findOrder(scope.coi, scope.patientInformation.patientId);
  ...
  it('Satellite Lab flow', () => {
    ...
    sat_steps.satLabVerifyShipment(scope.coi, 'us-cclp-cilta', 'from-satellite-lab', 'to-manufacturing-site');
    ...
    sat_steps.satLabTransferProductToShipper('-us-cclp-cilta', scope.coi);
  ...
  it('Manufacturing flow', () => {
    ...
    m_steps.manufacturingVerifyShipper(scope.coi,'us-cclp-cilta', 'from-satellite-lab', 'to-manufacturing-site');
    ...
    m_steps.shippingManufacturing(2, scope, input.subjectNumberInput, input.evoLast4Digits, input.tamperSealNumber, true);
  ...
  it('Infusion flow', () => {
    ...
    cy.get('.patient-id')
      ...
      .click();
    inf_steps.infusionReceiveShipment('manufacturing-site', '-us-cclp-cilta', scope.coi);
    inf_steps.infusionShipmentReceiptChecklist(input.evoLast4Digits, input.tamperSealNumber, false);
