import order_steps from '../../HappyPath_steps/CCCP_US_HappyPath/ordering_steps';
import col_steps from '../../HappyPath_steps/CCCP_US_HappyPath/collection_steps';
import m_steps from '../../HappyPath_steps/CCCP_US_HappyPath/manufacturing_steps';
import sat_steps from '../../HappyPath_steps/CCCP_US_HappyPath/satelite_lab_steps';
import inf_steps from '../../HappyPath_steps/CCCP_US_HappyPath/infusion_steps';
...
export default {
  ...
  commonCollectionHappyPath: (scope, therapy) => {
    ...
    cy.get(`@coi`).then(coi => {
      ...
      col_steps.collectionTransferProductToShipper(coi, "ln-2-shipper-ship-bags-from-apheresis-site-to-satellite-lab-cccp");
