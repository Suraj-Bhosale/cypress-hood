...
import collectionSteps from '../../HappyPath_steps/CMLP_CILTA_RARITAN_HappyPath/collection_steps_cilta'
...
export default {
    ...
    transferProductToShipper: {
        ...
        dinBlank: (coi) => {
            ...
            cy.reload();
            inputHelpers.inputSingleField('[data-testid="ln-2-shipper-ship-bags-from-apheresis-site-to-manufacturing-site-us-cmlp-cilta-input-field"]', coi);
            actionButtonsHelper.checkActionButtonIsDisabled('primary');
        },
        ...
        verifySaveAndCloseBtn: (scope) => {
            ...
            inputHelpers.scanAndVerifyCoi('ln-2-shipper-ship-bags-from-apheresis-site-to-manufacturing-site-us-cmlp-cilta', scope.coi);
            actionButtonsHelper.checkActionButtonIsEnabled('primary');
            ...
            inputHelpers.checkMarkVisible('[data-testid="ln-2-shipper-ship-bags-from-apheresis-site-to-manufacturing-site-us-cmlp-cilta-check-mark"]');
        }
    },
    ...
    shipmentChecklist: {
        previousHappypathSteps: (therapy , scope) => {
            ...
            cy.openOrder('collection','phil');
            cy.commonPagination(scope.patientId,'Patients');
            collectionSteps.transferProductToShipper(scope.coi,input.din,"us-cmlp-cilta","apheresis-site","manufacturing-site");
        },
    ...
    checkStatusesOfCollectionModule: (scope,therapy) => {
        ...
        collectionSteps.transferProductToShipper(coi, input.day1Bag1Udn, 'us-cmlp-cilta', 'apheresis-site', 'manufacturing-site');
