import order_steps from '../../HappyPath_steps/LCLP_US_HappyPath/ordering_steps';
import col_steps from '../../HappyPath_steps/LCLP_US_HappyPath/collection_steps';
import m_steps from '../../HappyPath_steps/LCLP_US_HappyPath/manufacturing_steps';
import inf_steps from '../../HappyPath_steps/LCLP_US_HappyPath/infusion_steps';
...
export default {
  ...
  commonOrderingHappyPath: (scope, therapy) => {
    ...
    order_steps.schedulingCheckAvailability(therapy, therapy.region);
