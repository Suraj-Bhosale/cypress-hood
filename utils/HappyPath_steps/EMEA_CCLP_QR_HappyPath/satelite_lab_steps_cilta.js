...
export default {
  ...
  satLabCollectionSummary: (scope, therapy) => {
    ...
    if (Cypress.env('runWithTranslations')) {
      ...
      //section titles
      //patient data
      translationHelpers.assertChildElement('[data-test-id="ordering-summary-block"]', 'h3', satLabAssertions.collectionSummary.patientdata, 0);
      //procedure details
      translationHelpers.assertChildElement('[data-test-id="collection-summary-block"]', 'h3', satLabAssertions.collectionSummary.procedureDetails, 0);
      //bag information
      translationHelpers.assertChildElement('[data-test-id="collection-summary-block"]', 'h3', satLabAssertions.collectionSummary.bagInformation, 1);
      ...
      //value
      translationHelpers.assertSectionChildElement('[data-testid=display-only]', 2, 'span', inputs.collectionSiteName1);
      ...
      //value
      // translationHelpers.assertSectionChildElement('[data-testid=display-only]', 4, 'span', scope.patientInformation.monthOfBirth);
      ...
      //value
      // translationHelpers.assertSectionChildElement('[data-testid=display-only]', 5, 'div', scope.patientInformation.yearOfBirthSatLabCommercial, 1);
    ...
    if (Cypress.env('runWithTranslations')) {
      ...
      if (therapy.unique_id == '_cmlp_cilta' || therapy.unique_id == '_cclp_cilta') {
        ...
        if (therapy.unique_id == '_cclp_cilta' || therapy.context == 'execution-context-cilta-cel-jnj-us-cmlp') {
          translationHelpers.assertSectionChildElement('[data-testid=display-only]', 0, 'span', inputs.collectionSiteName1);
        } else
  ...
  satLabCryopreservationData: ( productVolume) => {
    ...
    cy.get('[data-testid="#/properties/shipping_checklist/properties/bag_1_product_volume-input"]').type(productVolume);
