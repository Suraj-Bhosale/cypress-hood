...
export default {
	...
	collectionSummaryEmeaLc: (scope) => { // translations
		if (Cypress.env('runWithTranslations')) {
	...
	cryopreservationTransferProductToShipperEmeaLc: (coi, therapy, fromSite, toSite) => {
		...
		if (Cypress.env('runWithTranslations')) { // Title
			...
			// labels
			translationHelpers.assertSingleField('[data-testid=question-text-case_intact_1]', collectionCiltaAssertion.transferToShipper.questionCaseLclp)
	...
	cryopreservationShipmentChecklist: scope => {
		if (Cypress.env('runWithTranslations')) {
			...
			// labels
			translationHelpers.assertSingleField('[data-test-id="label-step-row-description"]', collectionCiltaAssertion.shipmentChecklist.enterAirWaybillEmea)
			...
			translationHelpers.assertSingleField('[data-test-id="shipping-checklist-block-block"] >>>> :nth(19)', collectionCiltaAssertion.shipmentChecklist.additionalComment)
	...
	collectionShippingSummaryEmeaLc: (scope, therapy) => {
		if (Cypress.env('runWithTranslations')) {
			...
			translationHelpers.assertSectionChildElement('[data-testid="display-only"]', 1, 'span', inputs.siteName2);
			...
			translationHelpers.assertTxtFieldLayout(collectionCiltaAssertion.shipmentSummary.containerCaseLcEmealcdc)
			translationHelpers.assertTxtFieldLayout(collectionCiltaAssertion.shipmentSummary.tempOutOfRangeLcEmeaLc, "No")
