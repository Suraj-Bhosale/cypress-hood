...
export default {
  ...
  manufacturingShipReceiptSummaryVerify: (therapy, scope) => {
    ...
    if (Cypress.env('runWithTranslations')) {
      ...
      if (!['_emea_lcdc'].includes(therapy.unique_id)) {
        translationHelpers.assertSectionChildElement('[data-testid=display-only]', 0, 'span', inputs.testCoe2)
      }
  ...
  manufacturingProductReceiptSummaryVerifyEmeaLc: (therapy, scope) => {
    ...
    if (Cypress.env('runWithTranslations')) {
      ...
      if (therapy.unique_id == '_lclp_cilta') {
        ...
        translationHelpers.assertSectionChildElement('[data-testid=display-only]', 2, 'span', inputs.testCoe2)
      }
  ...
  manufacturingProductReceiptSummaryVerifyCilta: (therapy, scope) => {
    ...
    if (Cypress.env('runWithTranslations')) {
      ...
      translationHelpers.assertSingleField('[data-testid="txt-field-layout-Was there a temperature out-of-range alarm received? If yes, please contact the Vein to Vein team for further instructions."]',
