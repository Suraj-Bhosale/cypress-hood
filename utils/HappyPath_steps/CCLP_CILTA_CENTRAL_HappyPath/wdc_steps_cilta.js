    ...
    if (Cypress.env('runWithTranslations')) {
      ...
      translationHelpers.assertPageTitles("[data-test-id='wdc_shipping_world_distribution_center_summary']","h1",  wdcAssertions.shippingWDCSummary.title)
       ...
       wdcAssertions.shippingWDCSummary.sectionHeading2)
        ...
        translationHelpers.assertSingleField('[data-testid="txt-field-layout-Was there a temperature out-of-range alarm received? If yes, please contact the Vein to Vein team immediately and do NOT proceed until further instructions are given."]',
         wdcAssertions.shippingWDCSummary.labels.temperatureAlarmEmeaWDC)
        translationHelpers.assertSingleField('[data-testid="txt-field-layout-Is the shipping container case intact? If the shipping container is damaged or not in expected condition, please contact the Vein to Vein team."]',
