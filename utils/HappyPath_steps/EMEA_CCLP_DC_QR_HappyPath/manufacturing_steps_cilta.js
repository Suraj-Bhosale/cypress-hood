...
export default {
  ...
  manufacturingCollectionSummary: (therapy) => {
    if (Cypress.env('runWithTranslations')) {
      ...
      if (therapy.prefix == '_emea_cc') {
        ...
        translationHelpers.assertBlockLabel('[data-test-id="specimen-status-block"] >>>> span',
          { index: 2, label: manufacturingCiltaAssertion.collectionStatus.bagIdentifier })

        // translationHelpers.assertSingleField('[data-test-id="specimen-status-block"] >>>> span',
        ...
        translationHelpers.assertBlockLabel('[data-test-id="specimen-status-block"] >>> span',
          { index: 0, label: manufacturingCiltaAssertion.collectionStatus.numberOfBags })
  ...
  manufacturingVerifyShipperCcDcQr: (coi, therapy, fromSite, toSite) => {
  ...
  manufacturingShipmentReceiptChecklistCcDcQr: (evoLast4Digits, tamperSealNumber) => {
    if (Cypress.env('runWithTranslations')) {
      ...
      translationHelpers.assertSingleField('[data-testid=question-text-shipper_label_placed]',
        manufacturingCiltaAssertion.shippingReceipt.packingInsertShipperCcDcQr)
  ...
  manufacturingShipReceiptSummaryVerifyCcDcQr: (therapy, scope) => {
    ...
    if (Cypress.env('runWithTranslations')) {
      ...
      translationHelpers.assertTxtFieldLayout(manufacturingCiltaAssertion.shippingReceiptSummary.packingInsertIncludedCcDcQr)
  ...
  manufacturingShipReceiptSummaryVerify: (therapy, scope) => {
    ...
    if (Cypress.env('runWithTranslations')) {
      ...
      if (!['_emea_lcdc'].includes(therapy.unique_id)) {
        translationHelpers.assertSectionChildElement('[data-testid=display-only]', 0, 'span', inputs.siteName)
      }
