...
export default {
  ...
  infusionShipmentReceiptSummaryCcDcQr: (scope, therapy) => {
    ...
    if (Cypress.env('runWithTranslations')) {
      ...
      translationHelpers.assertSectionChildElement('[data-testid=display-only]', 2, 'span', input.collectionSiteNameCcDcQr)
  ...
  infusionShipmentReceiptSummary: (scope, therapy) => {
    ...
    if (Cypress.env('runWithTranslations')) {
      ...
      translationHelpers.assertSectionChildElement('[data-testid=display-only]', 2, 'div', infusionAssertions.shipmentReceiptSummary.siteName)
      translationHelpers.assertSectionChildElement('[data-testid=display-only]', 2, 'span', input.siteName)
  ...
  infusionProductReceiptSummaryCcDcQr: (scope, therapy) => {
