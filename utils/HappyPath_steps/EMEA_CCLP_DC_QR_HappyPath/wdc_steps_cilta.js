...
const wdcHeaderTranslations = (coi) => {
  ...
  export default {
      ...
      wdcShipmentReceiptChecklistSummaryCcDcQr: (therapy, scope, patientData) => {
        ...
        if (Cypress.env('runWithTranslations')) {
            ...
            translationHelpers.assertSectionChildElement('[data-testid="display-only"]',
            3,'div', wdcAssertions.shippingRecieptChecklistSummary.labels.orderIdCcDcQr,0);
    ...
    wdcProductRecieptSummaryEmeaCcDcQr: (therapy, patientData) => {
      ...
      if (Cypress.env('runWithTranslations')) {
          ...
          // 3,'span', patientData.siteNumber,0);
            ...
            translationHelpers.assertSectionChildElement('[data-testid="display-only"]',
            4, 'div', wdcAssertions.productRecieptSummary.labels.siteNumberEmea ,0)
          ...
          wdcAssertions.productRecieptSummary.labels.packingLN2ShipperCcDcQr);

          translationHelpers.assertSingleField('[data-test-id="multiple-scan-block-block"] >>>> :nth(4)',
          wdcAssertions.productRecieptSummary.labels.bagIdPlacedCcDcQr);
          ...
          translationHelpers.assertTxtFieldLayout(wdcAssertions.productRecieptSummary.labels.sealPlaceEmeaWDC);
          translationHelpers.assertTxtFieldLayout(wdcAssertions.productRecieptSummary.labels.temperatureMonitorEmeaWDC, "No")
    ...
    wdcProductRecieptSummaryEmea: (therapy, patientData) => {
      ...
      if (Cypress.env('runWithTranslations')) {
          ...
          translationHelpers.assertTxtFieldLayout(wdcAssertions.productRecieptSummary.labels.sealPlaceEmeaWDC);
          translationHelpers.assertTxtFieldLayout(wdcAssertions.productRecieptSummary.labels.temperatureMonitorEmeaWDC, "No")
          translationHelpers.assertTxtFieldLayout(wdcAssertions.productRecieptSummary.labels.expectedConditionEmeaWDC);
    ...
    wdcTransferProductToStorageEmea: (coi, therapy) => {
     ...
     wdcProductReceiptEmeaCcDcQr: (therapy, pisNumber) => {
      if (Cypress.env('runWithTranslations')) {
          //TITLE
      ...
      //    wdcAssertions.productReciept.labels.inverstProduct);
         ...
         wdcAssertions.productReciept.labels.sealPlaceEmeaWDC);

         translationHelpers.assertSingleField('[data-testid=question-text-temperature_monitor]',
         wdcAssertions.productReciept.labels.temperatureMonitorEmeaWDC);

         translationHelpers.assertSingleField('[data-testid="question-text-expected_condition"]',
         wdcAssertions.productReciept.labels.expectedConditionEmeaWDCCcDcQr);
    ...
    wdcProductReceiptEmea: (therapy, pisNumber) => {
        ...
        //    wdcAssertions.productReciept.labels.inverstProduct);
           ...
           translationHelpers.assertSingleField('[data-testid="question-text-expected_condition"]',
           wdcAssertions.productReciept.labels.expectedConditionEmeaWDC);
    ...
    wdcTransferProductToShipperEmeaCcdc: coi => {
        if (Cypress.env('runWithTranslations')) {
            ...
            wdcAssertions.transferShipper.labels.containerDamagedEmeaWDC);

            translationHelpers.assertSingleField('[data-testid="question-text-tempreture_alarm"]',
            wdcAssertions.transferShipper.labels.temperatureAlarmEmeaWDC);
            ...
            translationHelpers.assertSingleField('[data-testid=bag-1-desc]',
            wdcAssertions.transferShipper.labels.descriptionEMEA);

            translationHelpers.assertSingleField('[data-test-id="multiple-scan-block-block"] >>>>> :nth(0)',
            wdcAssertions.transferShipper.labels.coiBagIdentifierEmeaWDC);
   ...
   wdcShippingWorldDistributionCenterSummaryEmeaCcdcQr: (therapy, coi) => {
    ...
    if (Cypress.env('runWithTranslations')) {
      ...
      translationHelpers.assertPageTitles("[data-test-id='wdc_shipping_world_distribution_center_summary']","h1",  wdcAssertions.shippingWDCSummary.title)
       ...
       translationHelpers.assertSingleField('[data-test-id="multiple-scan-block-block"] >>>> :nth(0)',
       wdcAssertions.shippingWDCSummary.labels.coiBagIdentifierEmeaWDCCcDcQr)

       translationHelpers.assertSingleField('[data-test-id="multiple-scan-block-block"] >>>> :nth(4)',
       wdcAssertions.shippingWDCSummary.labels.scanPackingCcDcQr)
       ...
       translationHelpers.assertTxtFieldLayout(wdcAssertions.shippingWDCSummary.labels.caseIntactEmeaWDC);
       ...
       if(therapy.unique_id == "_emea_ccdc_qr"||therapy.unique_id == "_emea_lcdc_qr" | therapy.unique_id == "_emea_lcdc"){
        ...
        wdcAssertions.shippingWDCSummary.labels.temperatureAlarm);
         ...
         translationHelpers.assertTxtFieldLayout(wdcAssertions.shippingWDCSummary.labels.temperatureAlarmEmeaWDC)
       }
   ...
   wdcShippingWorldDistributionCenterSummaryEmeaCcdc: (therapy, coi) => {
    ...
    if (Cypress.env('runWithTranslations')) {
      ...
      translationHelpers.assertPageTitles("[data-test-id='wdc_shipping_world_distribution_center_summary']","h1",  wdcAssertions.shippingWDCSummary.title)
       ...
       translationHelpers.assertSingleField('[data-test-id="multiple-scan-block-block"] >>>> :nth(0)',
       wdcAssertions.shippingWDCSummary.labels.coiBagIdentifierEmeaWDC)
