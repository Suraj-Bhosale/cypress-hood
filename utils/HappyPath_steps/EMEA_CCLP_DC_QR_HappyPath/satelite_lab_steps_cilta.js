...
export default {
  ...
  satLabCollectionSummaryCcDcQr: (scope, therapy) => {
    ...
    if (Cypress.env('runWithTranslations')) {
      ...
      //value
      translationHelpers.assertSectionChildElement('[data-testid=display-only]', 2, 'span', inputs.collectionSiteNameCcDcQr);
      ...
      //value
      translationHelpers.assertSectionChildElement('[data-testid=display-only]', 3, 'span', inputs.dayOfBirthEmeaCcDcQr);
      ...
      //value
      translationHelpers.assertSectionChildElement('[data-testid=display-only]', 4, 'span', inputs.monthOfBirthEmeaCcDcQr);
      ...
      //value
      translationHelpers.assertSectionChildElement('[data-testid=display-only]', 5, 'div', inputs.yearOfBirthSatLabCommercialCcDcQr, 1);
  ...
  satLabCollectionSummary: (scope, therapy) => {
    ...
    if (Cypress.env('runWithTranslations')) {
      ...
      //value
      translationHelpers.assertSectionChildElement('[data-testid=display-only]', 2, 'span', inputs.collectionSiteName);

      //day of birth
      translationHelpers.assertSectionChildElement('[data-testid=display-only]', 3, 'div', satLabAssertions.collectionSummary.dayOfBirth);
      //value
      translationHelpers.assertSectionChildElement('[data-testid=display-only]', 3, 'span', inputs.dayOfBirth);
  ...
  satLabVerifyShipmentCcDcQr: (coi, therapy, fromSite, toSite) => {
    ...
    cy.get(`[data-testid="ln-2-shipper-ship-bags-from-satellite-lab-to-manufacturing-site-emea-ccdc-qr-input-field"]`).type(coi);
    cy.get(`[data-testid="ln-2-shipper-ship-bags-from-satellite-lab-to-manufacturing-site-emea-ccdc-qr-action-trigger-button"]`).click();
    cy.wait('@labelVerifications');
  ...
  satLabShipmentChecklistCcDcQr: (DIN, therapy) => {
    ...
    if (Cypress.env('runWithTranslations')) {
      ...
      //   translationHelpers.assertSingleField('[data-testid=question-text-does_temperature_conform]', satLabAssertions.shipmentReceiptChecklist.tempratureQuestion2C);
      ...
      // }
      // else {
        translationHelpers.assertSingleField('[data-testid=question-text-does_temperature_conform]', satLabAssertions.shipmentReceiptChecklist.tempratureQuestionCcDcQr);
        translationHelpers.assertSingleField('[data-testid=question-text-cold_shipper]', satLabAssertions.shipmentReceiptChecklist.coldShipperQuestionCcDcQr);
      // }
  ...
  satLabShipmentChecklistSummaryCcDcQr: (scope, therapy) => {
    ...
    if (Cypress.env('runWithTranslations')) {
      ...
      //lables
      //received packing
      // translationHelpers.assertSectionChildElement('[data-test-id="label-verification-step-row-block"]', 0, 'div', satLabAssertions.shipmentReceiptChecklistSummary.receivedPackingInsert, 2);
      //value
      ...
      if (therapy.unique_id == '_cmlp_cilta' || therapy.unique_id == '_cclp_cilta') {
        ...
        if (therapy.unique_id == '_cclp_cilta' || therapy.context == 'execution-context-cilta-cel-jnj-us-cmlp') {
          translationHelpers.assertSectionChildElement('[data-testid=display-only]', 0, 'span', inputs.collectionSiteName);
        } else
          translationHelpers.assertSectionChildElement('[data-testid=display-only]', 0, 'span', inputs.cryoInstitution);
      } else {
        translationHelpers.assertSectionChildElement('[data-testid=display-only]', 0, 'span', inputs.collectionSiteNameCcDcQr);
      }
      //airwayBill
      translationHelpers.assertSectionChildElement('[data-testid=display-only]', 1, 'div', satLabAssertions.shipmentReceiptChecklistSummary.airwayBill);
      //value TODO
      ...
      if (therapy.unique_id == '_emea_cc' || therapy.unique_id == '_emea_ccdc_qr' || therapy.unique_id == '_cclp_cilta' || therapy.unique_id == '_emea_ccdc' || therapy.unique_id == '_cmlp_cilta' || therapy.unique_id == '_emea_cc_qr') {
        ...
        translationHelpers.assertTxtFieldLayout(satLabAssertions.shipmentReceiptChecklistSummary.tempratureQuestionCcDcQr,);
  ...
  satLabTransferProductToShipper: (coi, therapy) => {
    ...
    if (Cypress.env('runWithTranslations')) {
      ...
      if (therapy.unique_id == '_cclp_cilta') {
        ...
        translationHelpers.assertChildElement('[data-test-id="multiple-scan-block-block"]', 'div', satLabAssertions.transferProductToShipper.ln2_packing_insert_emea, 11);

      //toggle question translations
      //is the shipping container case intact
      translationHelpers.assertSingleField('[data-testid=question-text-case_intact_1]', satLabAssertions.transferProductToShipper.caseIntact_emea_cc);
      //was there a temprature out of range alarm reached
      translationHelpers.assertSingleField('[data-testid=question-text-temp_out_of_range_1]', satLabAssertions.transferProductToShipper.temp_out_of_range_emea_cc);
  ...
  satLabTransferProductToShipperCcDcQr: (coi, therapy) => {
    ...
    if (Cypress.env('runWithTranslations')) {
      ...
      //toggle question translations
      //is the shipping container case intact
      translationHelpers.assertSingleField('[data-testid=question-text-case_intact_1]', satLabAssertions.transferProductToShipper.caseIntact_emea_cc_dc_qr);
      //was there a temprature out of range alarm reached
      translationHelpers.assertSingleField('[data-testid=question-text-temp_out_of_range_1]', satLabAssertions.transferProductToShipper.temp_out_of_range_emea_cc_dc_qr);
      //Confirm cryopreserved apheresis product cassette(s) were not exposed
      translationHelpers.assertSingleField('[data-testid=question-text-ambient_temperature_exposure]', satLabAssertions.transferProductToShipper.ambient_temperature_exposure);
      //is the red wiretamper seal labelled
      translationHelpers.assertSingleField('[data-testid=question-text-red_wire_tamper_seal_labeled_rack]', satLabAssertions.transferProductToShipper.red_wire_temper_seal);
  ...
  satShippingSummaryVerifyCcDcQr: (scope, therapy) => {
    if (Cypress.env('runWithTranslations')) {
      //title
      ...
      //scan or enter coi
      translationHelpers.assertChildElement('[data-test-id="multiple-scan-block-block"]', 'div', satLabAssertions.cryopreservationShippingSummary.dateAndTimeCryopreservedApheresisProductCassetteCcDcQr, 3);
      translationHelpers.assertChildElement('[data-test-id="multiple-scan-block-block"]', 'div', `${scope.coi}-PRC-01`, 6);

      translationHelpers.assertBlockLabel('[data-test-id="multiple-scan-block-block"]>>>>', { index: 4, label: satLabAssertions.cryopreservationShippingSummary.dateAndTimePackagedCryopreservedApheresisCcDcQr });
      ...
      translationHelpers.assertTxtFieldLayout(satLabAssertions.transferProductToShipper.caseIntact_emea_cc_dc_qr);
      translationHelpers.assertTxtFieldLayout(satLabAssertions.transferProductToShipper.temp_out_of_range_emea_cc_dc_qr, 'No');
  ...
  satShippingSummaryVerify: (scope, therapy) => {
    if (Cypress.env('runWithTranslations')) {
      ...
      translationHelpers.assertTxtFieldLayout(satLabAssertions.transferProductToShipper.caseIntact_emea_cc);
      translationHelpers.assertTxtFieldLayout(satLabAssertions.transferProductToShipper.temp_out_of_range_emea_cc, 'No');
      translationHelpers.assertTxtFieldLayout(satLabAssertions.shipmentChecklist.tamper_seal_number_question);
      translationHelpers.assertSingleField(`[data-testid='txt-field-layout-Is the red wire tamper seal labeled "RACK" in place on the cassette rack?']`, satLabAssertions.transferProductToShipper.red_wire_temper_seal);
      translationHelpers.assertSingleField(`[data-testid='txt-field-layout-Is the red wire tamper seal labeled "RACK" in place on the cassette rack?-answer']`, 'Yes ');
  ...
  satSummaryVerifyCcDcQr: (scope, therapy) => {
    if (Cypress.env('runWithTranslations')) {
      //title
      translationHelpers.assertPageTitles('[data-test-id="satellite_lab_cryopreservation_summary"]', 'h1', satLabAssertions.cryopreservationSummary.title);
      ...
      if (therapy.unique_id == "_emea_ccdc_qr") {
        ...
        //scan or enter coi
        translationHelpers.assertChildElement('[data-test-id="multiple-scan-block-block"]', 'div', satLabAssertions.cryopreservationSummary.scanOrEnterCcDcQr, 3);
        //value
        translationHelpers.assertChildElement('[data-test-id="multiple-scan-block-block"]', 'div', `${scope.coi}-PRC-01`, 6);
      }
      //label translations
