...
describe('EU SG Tesscar Regression Path', () => {
  ...
  describe('Infusion Flow', () => {
    ...
    it('Finished Product Receipt Summary', () => {
      ...
      regressionInfusionSteps.finishedProductReceiptSummary.previousHappyPathSteps(scope);

      // C24343	[POS] Verify whether order can be approved after signature is done.
      regressionInfusionSteps.finishedProductReceiptSummary.verifyOrderAfterSignature();
    })
  })
})
