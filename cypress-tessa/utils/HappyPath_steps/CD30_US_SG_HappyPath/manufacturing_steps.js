...
export default {
  ...
  collectionSummary: () => {
    ...
    if (Cypress.env('runWithHelpers')) {
      ...
      translationHelpers.assertSectionChildElement('[data-test-id="section-heading-block-block"]',
        1,'div', manufacturingAssertions.collectionSummary.sectionSecond,0);
      translationHelpers.assertSectionChildElement('[data-testid="display-only"]',
      ...
      translationHelpers.assertSectionChildElement('[data-test-id="specimen-status-block"]>div>div>div',
        0,'span', manufacturingAssertions.collectionSummary.dateCollected,0);
      translationHelpers.assertSectionChildElement('[data-test-id="specimen-status-block"]>div>div',
        1,'span', manufacturingAssertions.collectionSummary.collectionBagCount,0);
      translationHelpers.assertSectionChildElement('[data-test-id="specimen-status-block"]>div>div',
        1,'span', manufacturingAssertions.collectionSummary.collectionBagCountValue,1);
      translationHelpers.assertSectionChildElement('[data-test-id="specimen-status-block"]>div>div>div',
        1,'span', manufacturingAssertions.collectionSummary.bagIdentifierOne,0);
      cy.get(`@coi`).then(coi =>{
        translationHelpers.assertSectionChildElement('[data-test-id="specimen-status-block"]>div>div>div',
        1,'span', `${coi}-PRC-01`,1);
      });
      translationHelpers.assertSectionChildElement('[data-test-id="specimen-status-block"]>div>div>div',
        2,'span', manufacturingAssertions.collectionSummary.bagIdentifierThree,0);
      cy.get(`@coi`).then(coi =>{
        translationHelpers.assertSectionChildElement('[data-test-id="specimen-status-block"]>div>div>div',
        2,'span', `${coi}-PRC-03`,1);
      });
      translationHelpers.assertSectionChildElement('[data-test-id="view-document-block"]',
        2,'p', manufacturingAssertions.collectionSummary.cryoSummary,0);
      translationHelpers.assertSectionChildElement('[data-test-id="view-document-block"]',
        3,'p', manufacturingAssertions.collectionSummary.conditionalRelease,0);
      translationHelpers.assertSectionChildElement('[data-test-id="view-document-block"]',
        4,'p', manufacturingAssertions.collectionSummary.finalRelease,0);
    }
  ...
  shipmentReceiptChecklist: () => {
    ...
    if (Cypress.env('runWithHelpers')) {
      ...
      inputHelpers.inputSingleField('[data-testid="satellite-awb-input-field"]',
        inputs.manufacturing.global.satLWrongAwb)
      inputHelpers.clicker('[data-testid="satellite-awb-action-trigger-button"]')
  ...
  pbmcReceiptSummary: () => {
    ...
    if (Cypress.env('runWithHelpers')) {
      translationHelpers.assertPageTitles('[data-test-id="manufacturing_pbmc_receipt_summary"]','h1',
        manufacturingAssertions.pbmcReceiptSummary.title)
      translationHelpers.assertSingleField('[data-testid="progress-receive_materials-name"]',
        manufacturingAssertions.pbmcReceiptSummary.phaseName)
      translationHelpers.assertSectionChildElement('[data-test-id="section-heading-block-block"]',0,
        'h3', manufacturingAssertions.pbmcReceiptSummary.bagScan,0);
      translationHelpers.assertSectionChildElement('[data-test-id="shipping-checklist-summary-block-block"]',0,
        'h3', manufacturingAssertions.pbmcReceiptSummary.materialConditionDetails);
      translationHelpers.assertSingleField('[data-testid="txt-field-layout-Is the PBMC bag in expected good condition?"]',
        manufacturingAssertions.pbmcReceiptSummary.bagCondition)
      translationHelpers.assertSingleField('[data-testid="txt-field-layout-I have received the total number of bags as displayed above."]',
        manufacturingAssertions.pbmcReceiptSummary.bagsReceiptConfirmation)
    }
  ...
  finalQualityRelease: () => {
    cy.log('Final Quality Release');
    cy.wait(3000);
    if (Cypress.env('runWithHelpers')) {
    translationHelpers.assertPageTitles('[data-test-id="manufacturing_final_quality_release"]','h1',
      manufacturingAssertions.finalQualityRelease.title)
    translationHelpers.assertSingleField('[data-testid="progress-quality_release-name"]',
      manufacturingAssertions.finalQualityRelease.phaseName)
    translationHelpers.assertSectionChildElement('[data-test-id="section-heading-block-block"]',0,
  ...
  sponserRelease: () => {
    ...
    if (Cypress.env('runWithHelpers')) {
      translationHelpers.assertSectionChildElement('[data-test-id="section-heading-block-block"]',0,
        'h3',manufacturingAssertions.sponserRelease.reviewPbmc)
      translationHelpers.assertSectionChildElement('[data-test-id="section-heading-block-block"]',1,
        'h3',manufacturingAssertions.sponserRelease.reviewQuality)
      translationHelpers.assertSectionChildElement('[data-test-id="section-heading-block-block"]',2,
        'h3',manufacturingAssertions.sponserRelease.upload)
