...
import mfgStepsHappyPath from '../../../utils/HappyPath_steps/CD30_EU_SG_HappyPath/manufacturing_steps.js';
import mfgStepsOpenOrder from '../../../utils/Regression_steps/CD30_EU_SG_Regression/manufacturing_steps_regression.js';
...
export default {
  ...
  temperatureDataEu: {
    previousHappyPathSteps: (scope) => {
      ...
      mfgStepsHappyPath.pbmcReceiptEu(scope);
      mfgStepsHappyPath.pbmcReceiptSummaryEu();
    },
    ...
    backButtonPositive: () => {
      ...
      inputChecker.checkToggle('[data-testid="pass-button-temperature_data_confirm"]');
  ...
  pbmcReceiptEu:{
    ...
    //C32678
    scanAndVerifyEmptyNegative: () => {
      cy.log('PBMC Receipt C32678');
    ...
    //C32679
    scanAndVerifyInvalidNegative: () => {
      cy.log('PBMC Receipt C32679');
      cy.reload();
      ...
      inputHelpers.inputSingleField('[data-testid="bag-identifier-1-input"]',
        regressionInput.manufacturing.pbmcReceipt.invalidDataForBag);
    ...
    //C32682
    withoutSelectingFirstBagConditionToggleButtonNegative: () => {
      cy.log('PBMC Receipt C32682');
      cy.reload();
      inputChecker.explicitWait('[data-test-id="manufacturing_pbmc_receipt"]');
      cy.get(`@coi`).then(coi =>{
    ...
    //C32683
    firstBagConditiontoggleButtonNegative: () => {
      cy.log('PBMC Receipt C32683');
      cy.reload();
      inputChecker.explicitWait('[data-test-id="manufacturing_pbmc_receipt"]');
      inputHelpers.clicker('[data-testid="fail-button-pbmc_bag_condition"]')
      inputHelpers.clicker('[data-testid="pass-button-received_number_of_bags"]')
      inputChecker.checkState('[data-testid="#/properties/shipping_receipt_checklist/properties/pbmc_bag_condition_reason-input"]','be.visible');
      actionButtonsHelper.checkActionButtonIsDisabled('primary');
    },

    //C50114
    withoutSelectingSecondBagConditiontoggleButtonNegative: () => {
      cy.log('PBMC Receipt C50114');
      cy.reload();
      inputChecker.explicitWait('[data-test-id="manufacturing_pbmc_receipt"]');
      inputHelpers.clicker('[data-testid="pass-button-pbmc_bag_condition"]')
      actionButtonsHelper.checkActionButtonIsDisabled('primary');
    ...
    //C50115
    secondBagConditiontoggleButtonNegative: () => {
      cy.log('PBMC Receipt C50115');
      cy.reload();
      inputChecker.explicitWait('[data-test-id="manufacturing_pbmc_receipt"]');
      inputHelpers.clicker('[data-testid="pass-button-pbmc_bag_condition"]')
      inputHelpers.clicker('[data-testid="fail-button-received_number_of_bags"]')
      inputChecker.checkState('[data-testid="#/properties/shipping_receipt_checklist/properties/received_number_of_bags_reason-input"]','be.visible');
      actionButtonsHelper.checkActionButtonIsDisabled('primary');
    },

    //C32753
    additionalCommentPositive: () => {
      cy.log('PBMC Receipt C32753');
      cy.reload();
      inputChecker.explicitWait('[data-test-id="manufacturing_pbmc_receipt"]');
      inputHelpers.clicker('[data-testid="pass-button-pbmc_bag_condition"]')
      inputHelpers.clicker('[data-testid="pass-button-received_number_of_bags"]')
    ...
    //C32755
    saveAndCloseButtonPositive: (coi) => {
      cy.log('PBMC Receipt C32755');
      cy.reload();
      inputChecker.explicitWait('[data-test-id="manufacturing_pbmc_receipt"]');
      inputHelpers.clicker('[data-testid="fail-button-pbmc_bag_condition"]')
      inputHelpers.inputSingleField('[data-testid="#/properties/shipping_receipt_checklist/properties/pbmc_bag_condition_reason-input"]',
      regressionInput.manufacturing.pbmcReceipt.reasonForToggleOne)
      inputHelpers.clicker('[data-testid="fail-button-received_number_of_bags"]')
      inputHelpers.inputSingleField('[data-testid="#/properties/shipping_receipt_checklist/properties/received_number_of_bags_reason-input"]',
      regressionInput.manufacturing.pbmcReceipt.reasonForToggleTwo)
      inputHelpers.inputSingleField('[data-testid="#/properties/shipping_receipt_checklist/properties/pbmc_receipt_comment-input"]',
      inputs.manufacturing.global.optCommentTwo)
      inputChecker.checkDataSavingWithSaveAndClose('','not.be.disabled',coi);

      inputChecker.checkToggle('[data-testid="fail-button-pbmc_bag_condition"]');
      inputChecker.checkToggle('[data-testid="fail-button-received_number_of_bags"]');
      inputChecker.checkValue('[data-testid="#/properties/shipping_receipt_checklist/properties/pbmc_bag_condition_reason-input"]', regressionInput.manufacturing.pbmcReceipt.reasonForToggleOne);
      inputChecker.checkValue('[data-testid="#/properties/shipping_receipt_checklist/properties/received_number_of_bags_reason-input"]', regressionInput.manufacturing.pbmcReceipt.reasonForToggleTwo);
      inputChecker.checkValue('[data-testid="#/properties/shipping_receipt_checklist/properties/pbmc_receipt_comment-input"]', inputs.manufacturing.global.optCommentTwo);
    },

    //C32757
    backButtonPositive: () => {
      cy.log('PBMC Receipt C32757');
      actionButtonsHelper.clickActionButton(actionButtonsHelper.actionButtonKeys.PRIMARY, {
        apiAliases: ['@patchProcedureSteps', '@getProcedures']
      });
      inputChecker.explicitWait('[data-test-id="manufacturing_pbmc_receipt_summary"]');
      inputChecker.checkDataSavingWithBackButton('not.be.disabled','[data-test-id="manufacturing_pbmc_receipt"]');
      actionButtonsHelper.checkActionButtonIsEnabled('primary');
      inputChecker.checkToggle('[data-testid="fail-button-pbmc_bag_condition"]');
      inputChecker.checkToggle('[data-testid="fail-button-received_number_of_bags"]');
      inputChecker.checkValue('[data-testid="#/properties/shipping_receipt_checklist/properties/pbmc_bag_condition_reason-input"]', regressionInput.manufacturing.pbmcReceipt.reasonForToggleOne);
  ...
  pbmcReceiptSummaryEu:{
    ...
    //C32762
    verifyNextButtonWithoutSignaturePositive: (coi) => {
    ...
    verifyDataWithEditButtonPositive: () => {
      ...
      inputHelpers.clicker('[data-testid="fail-button-collection_product_bag_condition"]')
      inputHelpers.inputSingleField('[data-testid="#/properties/shipping_receipt_checklist/properties/collection_product_bag_condition_reason-input"]',regressionInput.manufacturing.apheresisProductReceiptSummary.positivePleaseProvideRationaleForResponseConditionData);
      inputHelpers.inputSingleField('[data-testid="#/properties/shipping_receipt_checklist/properties/pbmc_receipt_comment-input"]',regressionInput.manufacturing.apheresisProductReceiptSummary.positiveAdditionalCommentsOne);
      inputChecker.nextButtonCheck('not.be.disabled')
      actionButtonsHelper.checkActionButtonIsEnabled('primary');
      actionButtonsHelper.clickActionButton(actionButtonsHelper.actionButtonKeys.PRIMARY, {
      });
      ...
      inputHelpers.clicker('[data-testid="reason-for-change-save"]');
      inputChecker.explicitWait('[data-testid="txt-field-layout-Is the collection bag in expected good condition?"]');
      ...
      translationHelpers.assertSectionChildElement('[data-testid="display-only"]',
        1,'span', regressionInput.manufacturing.apheresisProductReceiptSummary.positivePleaseProvideRationaleForResponseConditionData,0);

      translationHelpers.assertSectionChildElement('[data-testid="display-only"]',
        2,'div', regressionInput.manufacturing.apheresisProductReceiptSummary.positiveAdditionalCommentsOpt,0);
      translationHelpers.assertSectionChildElement('[data-testid="display-only"]',
        2,'span', regressionInput.manufacturing.apheresisProductReceiptSummary.positiveAdditionalCommentsOne,0);

      signatureHelpers.clickSignDocumentButton('approver', ['@postSignatures']);
      inputHelpers.clicker("[data-testid='edit-pbmc_receipt']")
      inputChecker.explicitWait("[data-testid='pass-button-collection_product_bag_condition']");
      inputHelpers.clicker("[data-testid='pass-button-collection_product_bag_condition']");
      inputHelpers.inputSingleField('[data-testid="#/properties/shipping_receipt_checklist/properties/pbmc_receipt_comment-input"]',regressionInput.manufacturing.apheresisProductReceiptSummary.positiveAdditionalCommentsTwo);
      inputChecker.nextButtonCheck('not.be.disabled')
      actionButtonsHelper.checkActionButtonIsEnabled('primary');
      actionButtonsHelper.clickActionButton(actionButtonsHelper.actionButtonKeys.PRIMARY, {
      });
      ...
      translationHelpers.assertSectionChildElement('[data-testid="display-only"]',
        1,'div', regressionInput.manufacturing.apheresisProductReceiptSummary.positiveAdditionalCommentsOpt,0);
      translationHelpers.assertSectionChildElement('[data-testid="display-only"]',
        1,'span', regressionInput.manufacturing.apheresisProductReceiptSummary.positiveAdditionalCommentsTwo,0);
      signatureHelpers.clickSignDocumentButton('approver', ['@postSignatures']);
      actionButtonsHelper.checkActionButtonIsEnabled('primary');
    }
  },

  manufacturingStartEu:{
    previousHappyPathSteps: (scope) => {
      mfgStepsOpenOrder.openOrder(scope);
      mfgStepsHappyPath.assignLotNumber(scope.treatment);
      mfgStepsHappyPath.collectionSummary();
  ...
  selectBagsToBeShippedEu:{
    previousHappyPathSteps: (scope) => {
      ...
      mfgStepsHappyPath.conditionalQualityRelease();
      mfgStepsHappyPath.finalQualityRelease();
      mfgStepsHappyPath.sponserReleaseEu();
  ...
  shippingChecklistEu : {
    ...
    printSummary: () =>{
      cy.log('Shipping Checklist');
      inputChecker.checkState('[name="manufacturingPhaseCd30EuShippingChecklistPrintSummary"]', 'be.enabled')
      actionButtonsHelper.clickActionButton(actionButtonsHelper.actionButtonKeys.PRIMARY, {
        apiAliases: ['@patchProcedureSteps', '@getProcedures']
      });
    }
