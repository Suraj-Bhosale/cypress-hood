...
export default {
  ...
  shipmentReceiptChecklist:{
    ...
    changeValue: () => {
      ...
      inputChecker.checkToggle('[data-testid="fail-button-manufacturing_awb_match"]');
    ...
    nextButtonDisable: () => {
      ...
      inputChecker.checkToggle('[data-testid="fail-button-seal_intact"]');
    }
  },
    ...
    shipmentReceiptSummary:{
      ...
      verifyWithSignature: () => {
        ...
        cy.reload(); //[BUG] Need to reload page after signature to get print summary button enable.
