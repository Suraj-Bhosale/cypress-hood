...
export default {
  ...
  scheduleCollection: {
    ...
    blankContactNameScheduleCollection: (institution) => {
      ...
      inputChecker.checkState(`[data-testid="btn-schedule"]`,'be.disabled')
      inputChecker.clearField('[data-testid="txt-contact-person-collection_cd30_us_sg"]');
      inputChecker.clickOnCheck('[data-testid="btn-schedule"]','be.disabled');
      translationHelpers.assertSingleField(`[data-testid="contact-person-invalid-collection_cd30_us_sg"]`,"Field can't be blank");
      inputChecker.nextButtonCheck('be.disabled');
    },
    //C20801
    blankContactPhoneNumberScheduleCollection: () => {
      cy.log('Schedule Collection');
      inputChecker.inputSingleFieldCheck('[data-testid="txt-contact-person-collection_cd30_us_sg"]', "Test Name", 'be.disabled');
      inputChecker.clearField('[data-testid="txt-phone-number-collection_cd30_us_sg"]');
      inputChecker.clickOnCheck('[data-testid="btn-schedule"]','be.disabled');
      translationHelpers.assertSingleField(`[data-testid="phone-number-invalid-collection_cd30_us_sg"]`,"Field can't be blank");
      inputChecker.nextButtonCheck('be.disabled');
    },
    //C20803
    validDataScheduleCollection: () => {
      cy.log('Schedule Collection');
      inputHelpers.inputSingleField('[data-testid="txt-phone-number-collection_cd30_us_sg"]','123456789');
    ...
    verifySaveAndCloseScheduleCollection: (patientInformation) => {
      ...
      inputChecker.checkValue('[data-testid="txt-contact-person-collection_cd30_us_sg"]','Test Name');
      inputChecker.checkValue('[data-testid="txt-phone-number-collection_cd30_us_sg"]','123456789');
    },
    //C20812
