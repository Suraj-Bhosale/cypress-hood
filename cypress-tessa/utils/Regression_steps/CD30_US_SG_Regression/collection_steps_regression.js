...
//import regressionCollectionSteps from "./../collection_steps_regression.js";
...
export default {
  ...
  collectionIdmTestResultsUs :{
    ...
    signatureBlock: ()=>{
      ...
      inputChecker.checkState("[data-testid='collection_idm_test_results-collection_idm_test_results_cd_30_us-signature-block']", 'be.visible')
      signatureHelpers.clickSignDocumentButton('approver', ['@postSignatures']);
      actionButtonsHelper.clickActionButton(actionButtonsHelper.actionButtonKeys.PRIMARY, {
        apiAliases: ['@patchProcedureSteps', '@getProcedures']
      });
